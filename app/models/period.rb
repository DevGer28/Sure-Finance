class Period
  ...
  def label
    if key_metadata
      I18n.t("periods.#{key}.label", default: key_metadata.fetch(:label))
    else
      I18n.t("periods.custom.label", default: "Custom Period")
    end
  end

  def label_short
    if key_metadata
      I18n.t("periods.#{key}.label_short", default: key_metadata.fetch(:label_short))
    else
      I18n.t("periods.custom.label_short", default: "Custom")
    end
  end

  def comparison_label
    if key_metadata
      I18n.t("periods.#{key}.comparison_label", default: key_metadata.fetch(:comparison_label))
    else
      I18n.t(
